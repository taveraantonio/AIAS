...
class TransformerEncoderLayer(BaseModule):
    ...
    def __init__(self,
        ...
        self.attn = EfficientMultiheadAttention(embed_dims=embed_dims,
                                                num_heads=num_heads,
...
class MiTransformer(BaseModule):
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(MiTransformer, self).__init__(init_cfg=init_cfg)
    ...
    def init_weights(self):
        if self.init_cfg is None:
            ...
            super(MiTransformer, self).init_weights()
